...
usePageTitle(() => cursor.value.toLocaleDateString(undefined, { month: 'long', year: 'numeric' }))
  ...
  <section class="calendar">
    <div class="split">
      <div class="board">
        <div class="toolbar">
          <div class="nav">
            <button type="button" class="step" aria-label="Previous month" @click="monthOffset--">
              ‹
            </button>
            <button type="button" class="today" @click="monthOffset = 0">Today</button>
            <button type="button" class="step" aria-label="Next month" @click="monthOffset++">
              ›
            </button>
          </div>
